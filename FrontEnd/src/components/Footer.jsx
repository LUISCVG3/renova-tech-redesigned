    ...
    return (
        <footer className="flex items-center justify-between bg-gray-950 w-full border-t border-gray-900  py-5 px-8">
            <div className="flex flex-col items-center md:items-start gap-4">
                ...
                <p className="font-['Inter'] text-xs uppercase tracking-widest text-gray-500">© 2024 RenovaTech. Solutions for the next generation. BY Luis Angel C. & Emiliano Corderoi</p>
            </div>
